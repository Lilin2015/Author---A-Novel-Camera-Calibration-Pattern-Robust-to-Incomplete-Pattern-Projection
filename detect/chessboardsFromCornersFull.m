...
function [chessboards,records]= chessboardsFromCornersFull(corners)
    ...
    if p_energy(min_idx)<energy
      ...
      if 0
        ...
        chessboards{1} = chessboard;
         I = imread('../data_new_pattern+polar/ab/image_23_a9.jpg');
       imshow(I);hold on;
